...
(function(a){
    var A=function(s,v){
        ...
        if(f.directionNav){
            e.append('<div class="nivo-directionNav"><a class="nivo-prevNav">Anterior</a><a class="nivo-nextNav">Próximo</a></div>');
            ...
            for(k=0;k<j.length;k++)if(f.controlNavThumbs){
                ...
                }else p.append('<a class="nivo-control" rel="'+k+'">'+(k+1)+"</a>");a(".nivo-controlNav a:eq("+g.currentSlide+")",e).addClass("active");
